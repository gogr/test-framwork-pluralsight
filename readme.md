...
[locally installed Chrome browser](https://www.seleniumhq.org/docs/03_webdriver.jsp#introducing-the-selenium-webdriver-api-by-pluralsight).
...
1. If browser doesn't start:
    ...
    1. Check if Glue is set to _com.pluralsight_ in _Run/Debug Configurations > Templates > Cucumber java > Glue_ line 
