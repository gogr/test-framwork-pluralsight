package com.pluralsight.pageObjects;

import com.pluralsight.BasePage;
import org.openqa.selenium.By;
import org.openqa.selenium.support.ui.ExpectedConditions;

import static com.pluralsight.helpers.ElementsInteraction.getWait;
...
//        Add verifications implemented using WebDriverWait that would be checking if the page is actually opened
        getWait().until(ExpectedConditions.titleIs("Pluralsight | THE Technology Skills Platform"));
    }
